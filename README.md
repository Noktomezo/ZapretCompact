...
## 🧐 Дополнительно
В дополнении к заблокированным сайтам можно так же разблокировать доступ к некоторым сайтам, которые блокируются "с той стороны" без использования VPN, настроив DNS от Comss по [инструкции](https://www.comss.ru/page.php?id=7315)
